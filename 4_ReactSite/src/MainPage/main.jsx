...
import AutoFreeTestPage from "../TestPage/TestPage.jsx";
    ...
    <StrictMode>
        <Router>
            <Routes>
                ...
                <Route path="/selectSite" element={<Select/>} /> {/* Selection-Seite */}
                <Route path="/freeTestSite" element={<FreeTestSite />} />
                <Route path="/autoTestSite" element={<AutoFreeTestPage/>}/>
            </Routes>
        </Router>
    </StrictMode>
);
